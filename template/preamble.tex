...
\usepackage[tmargin=2cm,rmargin=2cm,lmargin=2cm,margin=2cm,bmargin=2cm,footskip=.2in]{geometry}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{hyphenat}
\hyphenation{mate-máti-cas recu-perar secun-dario}
