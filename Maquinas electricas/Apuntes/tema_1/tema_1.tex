...
Magnitud fisica que indica la fuerza del campo magnético. Es representada por la letra \boldit{"\(H\)"}. Su unidad es el amperio-vuelta/metro (\(Av/m \)).\\ 
...
sin necesidad de aumentar la corriente \boldit{"\(I\)"}.
